    ...
    <header className="nav">
      <div className="wrap nav-in">
        ...
        <div className="nav-tools">
          ...
          <button className="icon-btn" aria-label="Cambiar tema" onClick={() => setTheme(theme === "dark" ? "light" : theme === "light" ? "system" : "dark")}>
            <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3a9 9 0 1 0 9 9c-5 0-9-4-9-9Z" /></svg>
          </button>
